...
<body>
    <!-- nav begin -->
    <nav class="navbar navbar-expand-sm bg-black bg-gradient sticky-top">
    <div class="container">
        <a class="navbar-brand text-light fw-bold " href="index.php">My Daily Journal</a>
        <button
    ...
    <!-- nav end -->
    <!-- content begin -->
<section id="content" class="p-5" style="padding:5px;">
    <div class="container">
        <?php
        if(isset($_GET['page'])){
        ?>
...
<!-- content end -->
 ...
 <!-- footer start -->
  <div class="wrapper d-flex flex-column min-vh-70">
